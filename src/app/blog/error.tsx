  ...
  return (
    <div className="flex flex-1 items-center justify-center p-6">
      <div className="max-w-sm text-center space-y-3">
        <p className="text-lg font-semibold text-neutral-900 dark:text-white">Blog couldn&apos;t load</p>
        <p className="text-sm text-neutral-500 dark:text-neutral-400">Something went wrong loading this page.</p>
