      ...
      <main className="mx-auto max-w-5xl px-4 sm:px-6 py-8 sm:py-10 space-y-8">
        ...
        <footer className="text-center text-xs text-neutral-400 pt-8 border-t border-neutral-100 dark:border-neutral-800 space-y-3">
          <div className="flex items-center justify-center gap-4">
            ...
            <Link href={`/compliance?scan=${scan.id}`} className="text-sm text-blue-600 hover:underline">Compliance</Link>
          </div>
          <p>Generated by <Link href="/" className="hover:underline">RegLayer</Link> — Web Accessibility Intelligence</p>
