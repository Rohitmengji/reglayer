    ...
    <footer className="border-t border-neutral-100 dark:border-neutral-800 bg-neutral-50 dark:bg-neutral-900 py-8 sm:py-12">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6 sm:gap-8">
          ...
          <div>
            <p className="text-xs font-semibold uppercase tracking-wider text-neutral-600 dark:text-neutral-400 mb-3">Product</p>
          ...
          <div>
            <p className="text-xs font-semibold uppercase tracking-wider text-neutral-600 dark:text-neutral-400 mb-3">Legal</p>
            <ul className="space-y-1">
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="border-t border-neutral-200 dark:border-neutral-700 mt-8 pt-6 flex justify-center">
          <p className="text-xs text-neutral-600 dark:text-neutral-500">© {new Date().getFullYear()} RegLayer. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
