          ...
          <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
            <div className="relative" ref={langRef}>
              <button
                ...
                className="inline-flex items-center gap-1 sm:gap-1.5 rounded-lg border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-800 px-1.5 sm:px-2.5 py-1 sm:py-1.5 text-xs font-medium text-neutral-600 dark:text-neutral-300 hover:bg-neutral-50 dark:hover:bg-neutral-700 transition-all"
                aria-label="Select language"
                aria-expanded={langOpen}
              >
                <span className="text-sm leading-none">{currentLocale?.flag}</span>
                <span className="hidden sm:inline">{currentLocale?.name}</span>
                <ChevronDown className={`h-3 w-3 text-neutral-400 transition-transform duration-200 hidden sm:block ${langOpen ? "rotate-180" : ""}`} />
              </button>
              {langOpen && (
            ...
            <Link
              ...
              className="rounded-md bg-neutral-900 px-2 py-1 text-[11px] sm:px-4 sm:py-2 sm:text-sm font-medium text-white hover:bg-neutral-800 transition-colors dark:bg-white dark:text-neutral-900 dark:hover:bg-neutral-200 whitespace-nowrap leading-tight"
            >
