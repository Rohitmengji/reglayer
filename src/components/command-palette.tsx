...
export function CommandPalette() {
  ...
  const commands: CommandItem[] = useMemo(
    () => [
      ...
      { id: "nav-scans", label: "Scans", description: "All scan results", icon: Scan, action: () => navigate("/test?tab=scans"), group: "navigation", keywords: ["audit", "test", "check", "testing"] },
      ...
      { id: "nav-executive", label: "Executive Report", description: "C-suite compliance brief", icon: PieChart, action: () => navigate("/reports?tab=executive"), group: "navigation", keywords: ["report", "reports", "ceo", "board"] },
